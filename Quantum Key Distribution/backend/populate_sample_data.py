...
try:
    ...
    with app.app_context():
        ...
        print("
📈 Statistics Summary:"        print(f"   Total sessions: {total_sessions}")
        ...
        print("
📊 API Response Preview:"        print(f"   Total sessions: {stats[0].json['total_sessions']}")
        ...
        print("
🎉 Database populated successfully!"        print("The dashboard should now display meaningful statistics.")
