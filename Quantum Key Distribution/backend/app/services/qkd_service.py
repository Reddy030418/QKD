...
class QKDProtocolService:
    ...
    def run_bb84_protocol(self, parameters: Dict) -> Dict:
        ...
        try:
            ...
            # Save to database
            self.save_session_to_db(session_data, parameters)
    ...
    def save_session_to_db(self, session_data: Dict, parameters: Dict):
        ...
        try:
            ...
            log_entry = QKDSessionLog(
                ...
                data=json.dumps(session_data['stats'])
            )
            db.add(log_entry)
            db.commit()
